Original source: https://github.com/softaworks/agent-toolkit/tree/main/skills/session-handoff
...
- After substantial work (7+ file edits, complex debugging, architecture decisions)
